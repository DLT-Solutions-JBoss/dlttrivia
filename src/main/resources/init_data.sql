...
insert into user (user_id, first_name, last_name, email, status) values (10,'Jim','Propps', 'jim.propps@dlt.com', TRUE);
...
insert into user (user_id, first_name, last_name, email, status) values (19,'Michelle','Meadows', 'michelle.meadows@dlt.com', 'i');
...
insert into user (user_id, first_name, last_name, email, status) values (27,'Lakeisha','Thomas', 'lakeisha.thomas@dlt.com', TRUE);
...
insert into user (user_id, first_name, last_name, email, status) values (34,'Bryan','Little', 'bryan.little@dlt.com', TRUE);
